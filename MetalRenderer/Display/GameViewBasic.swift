...
class GameViewBasic: MTKView {
    ...
    func createRenderPipelineState(){
        ...
        let vertexFunction = library?.makeFunction(name: "final_vertex_shader")
        let fragmentFunction = library?.makeFunction(name: "final_fragment_shader")
