...
studiohdr_t *StudioModel::LoadModel( const void *buffer )
{
    int                    i;
    byte                *pin;
    studiohdr_t            *phdr;
...
studioseqhdr_t *StudioModel::LoadDemandSequences( char *modelname )
{
    ...
    return LoadDemandSequences(buffer);
}

studioseqhdr_t *StudioModel::LoadDemandSequences( const void *buffer )
{
...
void StudioModel::Init( const void *buffer )
{
    m_pstudiohdr = LoadModel( buffer );
    
//    char *modelname = m_pstudiohdr->name;
//
//    // preload textures
//    if (m_pstudiohdr->numtextures == 0)
//    {
