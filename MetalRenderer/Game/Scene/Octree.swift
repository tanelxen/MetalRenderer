...
public struct Box: CustomStringConvertible {
    ...
    public var boxSize: vector_float3 {
    ...
    public func contains(_ point: vector_float3) -> Bool {
...
public class Octree<T: Equatable>: CustomStringConvertible {
    ...
    @discardableResult
    public func add(_ element: T, at point: vector_float3) -> OctreeNode<T>? {
    ...
    public func elements(at point: vector_float3) -> [T]? {
